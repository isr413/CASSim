...
public class ScenarioSize64Probes32RandomWalkB extends RescueScenario {

  public ScenarioSize64Probes32RandomWalkB(ArgsParser args, int threadID, long seed) throws IOException {
    super(
        "ScenarioSize64Probes32RandomWalkB",  // scenarioID
        0,                                    // base count
        32,                                   // drone count
        1024,                                 // victim count
        0,                                    // cooldown
