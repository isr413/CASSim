...
public class ScenarioSize64Probes32QuadSmgC extends RescueScenario {

  public ScenarioSize64Probes32QuadSmgC(ArgsParser args, int threadID, long seed) throws IOException {
    super(
        "ScenarioSize64Probes32QuadSmgC",     // scenarioID
        0,                                    // base count
        32,                                   // drone count
        1024,                                 // victim count
        6,                                    // cooldown
