...
public class ReconCSelfish extends ReconScenario {

  public ReconCSelfish(ArgsParser args, int threadID, long seed) throws IOException {
    super(
        "ReconCSelfish",                      // scenarioID
        0,                                    // base count
        100,                                  // drone count
        30,                                   // intel count
        5,                                    // popup count
