...
public class ReconASelfish extends ReconScenario {

  public ReconASelfish(ArgsParser args, int threadID, long seed) throws IOException {
    super(
        "ReconASelfish",                      // scenarioID
        0,                                    // base count
        10,                                   // drone count
        5,                                    // intel count
        0,                                    // popup count
