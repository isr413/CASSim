...
public class ScenarioSize64Probes32RandomWalkC extends RescueScenario {

  public ScenarioSize64Probes32RandomWalkC(ArgsParser args, int threadID, long seed) throws IOException {
    super(
        "ScenarioSize64Probes32RandomWalkC",  // scenarioID
        0,                                    // base count
        32,                                   // drone count
        1024,                                 // victim count
        3,                                    // cooldown
