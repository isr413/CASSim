...
public class ScenarioSize64Probes32QuadSmgE extends RescueScenario {

  public ScenarioSize64Probes32QuadSmgE(ArgsParser args, int threadID, long seed) throws IOException {
    super(
        "ScenarioSize64Probes32QuadSmgE",     // scenarioID
        0,                                    // base count
        32,                                   // drone count
        1024,                                 // victim count
        9,                                    // cooldown
