...
public class ACSOS implements Application {
  ...
  private static RemoteConfig getBaseRemoteConfiguration() {
    return new RemoteConfig(
      new RemoteProto(
        ...
        new KinematicsProto(ACSOS.TRIAGE_TENT, new FuelProto(1, Vector.ZERO), new MotionProto())
      ),
      TeamColor.GREEN,
      ACSOS.BASE_COUNT,
      true,
  ...
  private static SensorProto getLongRangeComms() {
    return new SensorProto("LTE", null, null, new SensorStats(0, 1, 0));
  }
