...
public class VectorTest {
    ...
    @Test
    public void scaleNonUniformShouldProduceNewVectorWithScaledComponents() {
        Vector positives = new Vector(1, 2, 3);
        Vector negatives = new Vector(-4, -5, -6);
        Vector zeros = new Vector(0, 0, 0);
        ...
        VectorTest.assertVectorEquals(new Vector(3, 4, 3), Vector.scaleNonUniform(positives, scalePositive));
        assertNotSame(positives, Vector.scaleNonUniform(positives, scalePositive));
        VectorTest.assertVectorEquals(new Vector(-3, -4, -3), Vector.scaleNonUniform(positives, scaleNegative));
        assertNotSame(positives, Vector.scaleNonUniform(positives, scaleNegative));
        VectorTest.assertVectorEquals(zeros, Vector.scaleNonUniform(positives, scaleZero));
        assertNotSame(positives, Vector.scaleNonUniform(positives, scaleZero));
        VectorTest.assertVectorEquals(positives, Vector.scaleNonUniform(positives, scaleOne));
        assertNotSame(positives, Vector.scaleNonUniform(positives, scaleOne));
        VectorTest.assertVectorEquals(new Vector(-12, -10, -6), Vector.scaleNonUniform(negatives, scalePositive));
        assertNotSame(negatives, Vector.scaleNonUniform(negatives, scalePositive));
        VectorTest.assertVectorEquals(new Vector(12, 10, 6), Vector.scaleNonUniform(negatives, scaleNegative));
        assertNotSame(negatives, Vector.scaleNonUniform(negatives, scaleNegative));
        VectorTest.assertVectorEquals(zeros, Vector.scaleNonUniform(negatives, scaleZero));
        assertNotSame(negatives, Vector.scaleNonUniform(negatives, scaleZero));
        VectorTest.assertVectorEquals(negatives, Vector.scaleNonUniform(negatives, scaleOne));
        assertNotSame(negatives, Vector.scaleNonUniform(negatives, scaleOne));
        VectorTest.assertVectorEquals(zeros, Vector.scaleNonUniform(zeros, scalePositive));
        assertNotSame(zeros, Vector.scaleNonUniform(zeros, scalePositive));
        VectorTest.assertVectorEquals(zeros, Vector.scaleNonUniform(zeros, scaleNegative));
        assertNotSame(zeros, Vector.scaleNonUniform(zeros, scaleNegative));
        VectorTest.assertVectorEquals(zeros, Vector.scaleNonUniform(zeros, scaleZero));
        assertNotSame(zeros, Vector.scaleNonUniform(zeros, scaleZero));
        VectorTest.assertVectorEquals(zeros, Vector.scaleNonUniform(zeros, scaleOne));
        assertNotSame(zeros, Vector.scaleNonUniform(zeros, scaleOne));
    }
    ...
    @Test
    public void subtractShouldProduceNewVectorWithSubtractedComponents() {
        Vector positives = new Vector(1, 2, 3);
        Vector xneg = new Vector(-4, 5, 6);
        Vector yneg = new Vector(7, -8, 9);
        Vector zneg = new Vector(10, 11, -12);
        VectorTest.assertVectorEquals(new Vector(0, 0, 0), Vector.subtract(positives, positives));
        assertNotSame(positives, Vector.subtract(positives, positives));
        VectorTest.assertVectorEquals(new Vector(0, 0, 0), Vector.subtract(xneg, xneg));
        assertNotSame(xneg, Vector.subtract(xneg, xneg));
        VectorTest.assertVectorEquals(new Vector(5, -3, -3), Vector.subtract(positives, xneg));
        assertNotSame(positives, Vector.subtract(positives, xneg));
        assertNotSame(xneg, Vector.subtract(positives, xneg));
        VectorTest.assertVectorEquals(new Vector(-6, 10, -6), Vector.subtract(positives, yneg));
        assertNotSame(positives, Vector.subtract(positives, yneg));
        assertNotSame(yneg, Vector.subtract(positives, yneg));
        VectorTest.assertVectorEquals(new Vector(-9, -9, 15), Vector.subtract(positives, zneg));
        assertNotSame(positives, Vector.subtract(positives, zneg));
        assertNotSame(zneg, Vector.subtract(positives, zneg));
    }
    ...
    public void vector2DMathShouldProduceCorrectVectors() {
        ...
        VectorTest.assertVectorEquals(Vector.cross(a, b), Vector.cross(Vector.subtract(a, b), a));
        VectorTest.assertVectorEquals(Vector.cross(a, b), Vector.cross(Vector.subtract(a, b), b));
