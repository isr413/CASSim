...
public class ScenarioConfig {
    ...
    public static ScenarioConfig decode(JSONObject json) throws JSONException {
        ...
        return new ScenarioConfig(numDrones, droneSpec, numVictims, victimSpec, disasterScale,
    ...
    public ScenarioConfig(int numDrones, DroneSpecification droneSpec, int numVictims, VictimSpecification victimSpec,
